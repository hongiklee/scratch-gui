...
const MENU_MACHINE = 'machineMenu';
...
const openMachineMenu = () => openMenu(MENU_MACHINE);
const closeMachineMenu = () => closeMenu(MENU_MACHINE);
const machineMenuOpen = state => state.scratchGui.menus[MENU_MACHINE];
